...
/**
 * Cálculo de disponibilidade (slots) partilhado pelo cliente e pelo admin.
 * Fonte única da verdade: as horas livres respeitam os horários de
 * funcionamento (por profissional, com recurso às janelas gerais quando o
 * profissional não tem horário próprio), as reservas ativas e os bloqueios.
 */
...
/** Disponibilidade de um serviço num dia (por profissional ou união da equipa). */
