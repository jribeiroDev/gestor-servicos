  ...
  return (
    <section className="lg:min-h-screen">
      <header className="flex items-center justify-between border-b border-stone-200 bg-white px-5 py-5">
        <h2 className="text-2xl font-semibold text-stone-950">Serviços</h2>
      ...
      <div className="grid gap-5 p-5">
        {aEditar ? (
          <div className="rounded-lg border border-stone-200 bg-white p-5">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button onClick={fechar} aria-label="Fechar" className="rounded-md p-1 text-stone-500 hover:bg-stone-100">
                <X size={18} />
              </button>
            </div>
        ...
        {erro && !aEditar ? <p className="text-sm font-medium text-red-700">{erro}</p> : null}
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    <p className="font-medium text-stone-950">{servico.nome}</p>
                    <span
                      className={`rounded-md px-2 py-0.5 text-xs font-medium ${
                        servico.ativo ? "bg-teal-50 text-teal-800" : "bg-stone-100 text-stone-500"
                      }`}
                    >
                  ...
                  <p className="mt-1 text-sm text-stone-500">
                    {servico.duracao_minutos} min · {formatarPreco(servico.preco)} · ordem {servico.ordem}
                  </p>
                </div>
